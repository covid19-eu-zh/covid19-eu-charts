var mapbox_Token = "pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw";

var csv_url = 'https://raw.githubusercontent.com/covid19-eu-zh/covid19-eu-data/master/dataset/covid-19-de.csv';
var region_type = 'state';
var geojson_url = "https://raw.githubusercontent.com/codeforamerica/click_that_hood/master/public/data/germany.geojson";
...
Plotly.d3.csv(csv_url, function(err, rows){
    ...
    var data = [{
        ...
        z: daily_by_region.regions.map(function(reg) {return daily_by_region[reg].daily_cases[daily_by_region[reg].daily_cases.length-1]}),
